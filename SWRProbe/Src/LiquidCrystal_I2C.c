...
void LCDI2C_clear(){
	...
	DWT_Delay_us(3000);  // this command takes a long time!
}
...
void LCDI2C_expanderWrite(uint8_t _data){
	uint8_t i2c_Buffer[] = { (_data | lcdi2c.backlightval) };

	HAL_I2C_Master_Transmit(&hi2c1, (uint16_t) (lcdi2c.Addr << 1), i2c_Buffer, 1, 1000);
